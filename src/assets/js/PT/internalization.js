...
var Translation={
   ...
   "A SOLICITACÃO ESTA SENDO PROCESSADA": //token
        "A SOLICITACÃO ESTA SENDO PROCESSADA", //traduccion
   "INMEDIATAMENTE DEPOIS DE TERMINAR COMEÇARÁ A RECEBER O SERVIÇO":
        "IMEDIATAMENTE DE TERMINAR COMEÇARÁ A RECEBER O SERVIÇO",
   ...
   "Alcançou a quantidade máxima.":
    ...
    "Alcançou a quantidade maxima permitida":
            "Alcançou a quantidade máxima permitida",
    "Deseja elimiar o perfil de referência ":
            "Deseja eliminar o perfil de referência ",
    "Click para eliminar ":
            "Click para eliminar ",
    ...
    "Problemas na estrutura do email informado!":
            "Problemas na estrutura do email fornecido!",
    "Deve preencher todos os dados corretamente!":
            "Deve preencher todos os dados corretamente!",
    ...
    "Deseja elimiar a geolocalização ":
            "Deseja eliminar a geolocalização?",
